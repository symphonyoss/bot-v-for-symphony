...
import org.symphonyoss.proxydesk.models.actions.OnlineMembersAction;
...
public class HelpClientCommandListener extends AiCommandListener {
    ...
    private void init() {
        AiCommand command = new AiCommand(ProxyBotConfig.Config.getString(ProxyBotConfig.ONLINE_MEMBERS), 0);
